...
def snow17(time, prec, tair, lat=50, elevation=30, dt=24, scf=1.0, rvs=0,
           uadj=0.04, mbase=1.0, mfmax=1.5, mfmin=0.6, tipm=0.1, nmf=0.15,
    ...
    wi_list = np.zeros(nsteps)
    wq_list = np.zeros(nsteps)
    ...
    return model_swe, outflow, wi_list, wq_list
