...
REAL, INTENT(IN)                      :: HOUR    ! hour of day as real
REAL, INTENT(IN)                      :: DT      ! time step in units of hours
REAL, INTENT(IN)                      :: SLOPE   ! slope of ground surface in degrees
REAL, INTENT(IN)                      :: AZI     ! aspect (azimuth) of ground surface in degrees
REAL, INTENT(IN)                      :: LAT     ! latitude in degrees (negative for southern hemisphere)
! Ous
REAL, INTENT(OUT)                     :: HRI     ! average radiation index over time step DT
REAL, INTENT(OUT)                     :: COSZEN  ! average cosine of the zenith angle over time step DT
! Inal
REAL                                  :: CRAD    ! conversion from degrees to radians
REAL                                  :: YRAD    ! conversion from year to radians
REAL                                  :: T       ! time from noon in radians
REAL                                  :: DELT1   ! time step in radians
REAL                                  :: SLOPE1  ! slope of ground surface in radians
REAL                                  :: AZI1    ! aspect (azimuth) of ground surface in radians
REAL                                  :: LAT1    ! latitude in radians
REAL                                  :: FJULIAN ! julian date as real
REAL                                  :: D       ! solar declination
REAL                                  :: LP      ! latitude adjusted for non-level surface (= LAT1 for level surface)
REAL                                  :: TD      ! used to calculate sunrise/set
REAL                                  :: TPI     ! used to calculate sunrise/set
REAL                                  :: TP      ! used to calculate sunrise/set
REAL                                  :: DDT     ! used to calculate sunrise/set(= 0 for level surface)
REAL                                  :: T1      ! first time in time step or sunrise
REAL                                  :: T2      ! last time in time step or sunset
! ----------------------------------------------------------------------------------------
! CONVERSION FACTORS
!   degrees to radians
CRAD=PI/180._sp
...
! USE nrtype
 IMPLICIT NONE
 ! input
 INTEGER                             :: MONTH,DAY  ! month and day
 ! output
 INTEGER                             :: JULIAN     ! julian day
 ! internal
 INTEGER,DIMENSION(12)               :: MADD       ! julian day at start of each month
